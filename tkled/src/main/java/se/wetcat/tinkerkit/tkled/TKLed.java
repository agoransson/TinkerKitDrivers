package se.wetcat.tinkerkit.tkled;
 ...
 */
public class TKLed implements AutoCloseable {

    private static final String TAG = TKLed.class.getSimpleName();

    private final String mGpioName;

    private Gpio mGpio;

    public TKLed(String gpioName) {
    ...
    public void toggleOn() {
        ...
        try {
            ...
            Log.e(TAG, "Failed to toggle led on", e);
        }
    }
    ...
    public void toggleOff() {
        ...
        try {
            ...
            Log.e(TAG, "Failed to toggle led off", e);
        }
    }
